    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ap.play(Animals.this,numericmodels.get(viewPager.getCurrentItem()).getAudio());
            }
        });
        ...
        nm1.setImages(R.drawable.buffelo);
        nm2.setImages(R.drawable.bull);
        nm3.setImages(R.drawable.cat);
        nm4.setImages(R.drawable.camek);
        nm5.setImages(R.drawable.dog);
        nm6.setImages(R.drawable.donkey);
        nm7.setImages(R.drawable.goat);
        nm8.setImages(R.drawable.horswe);
        nm9.setImages(R.drawable.cow);
        nm10.setImages(R.drawable.sheep);

        nm1.setAudio(R.raw.buffelosound);
        nm2.setAudio(R.raw.bullsound);
        nm3.setAudio(R.raw.catsound);
        nm4.setAudio(R.raw.camelsound);
        nm5.setAudio(R.raw.dogsound);
        nm6.setAudio(R.raw.donkeysound);
        nm7.setAudio(R.raw.goatsound);
        nm8.setAudio(R.raw.horsesound);
        nm9.setAudio(R.raw.cowsound);
        nm10.setAudio(R.raw.sheepsound);
